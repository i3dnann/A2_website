  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-[#050308]">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(to right, rgba(168,85,247,0.25) 1px, transparent 1px), linear-gradient(to bottom, rgba(168,85,247,0.25) 1px, transparent 1px)",
      ...
      {/* glow orbs */}
      <motion.div
        className="absolute -top-40 -left-40 h-[38rem] w-[38rem] rounded-full bg-fuchsia-700/25 blur-[120px]"
        animate={{ x: [0, 60, 0], y: [0, 40, 0] }}
        transition={{ duration: 22, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute top-1/3 -right-40 h-[34rem] w-[34rem] rounded-full bg-violet-700/25 blur-[120px]"
      ...
      <div className="absolute inset-x-0 bottom-0 h-64 bg-gradient-to-t from-[#050308] to-transparent" />
    </div>
  );
}
