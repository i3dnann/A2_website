...
export function MagicCard(props: MagicCardProps) {
  const {
    ...
    gradientOpacity = 0.8,
    gradientFrom = "var(--site-primary)",
    gradientTo = "var(--site-accent)",
    mode = "gradient",
  } = props

  const glowFrom = isOrbMode(props) ? (props.glowFrom ?? "var(--site-primary)") : "var(--site-primary)"
  const glowTo = isOrbMode(props) ? (props.glowTo ?? "var(--site-accent)") : "var(--site-accent)"
