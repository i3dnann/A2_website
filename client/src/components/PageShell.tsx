  ...
  return (
    <section className="relative min-h-screen overflow-hidden pb-24 pt-36">
      ...
      <div className="relative mx-auto max-w-[90rem] px-5 sm:px-8 lg:px-12">
        <BlurFade duration={0.7} blur="12px" className="rounded-[2rem] border border-white/[.08] bg-white/[.025] px-6 py-10 shadow-[0_24px_80px_rgba(0,0,0,.22)] backdrop-blur-xl sm:px-10 sm:py-12">
