...
const RULES: { test: RegExp; icon: LucideIcon; color: string; glow: string }[] = [
  ...
  { test: /phone/i, icon: Smartphone, color: "text-violet-300", glow: "from-violet-500/25 to-violet-900/5" },
  ...
  { test: /diamond|gold|gem|jewel|ring|necklace/i, icon: Gem, color: "text-fuchsia-300", glow: "from-fuchsia-500/25 to-fuchsia-900/5" },
