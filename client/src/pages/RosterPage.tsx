      ...
      >
        ...
        >
          ...
          <div className="relative h-32 overflow-hidden bg-[radial-gradient(circle_at_top,#60519b55,transparent_58%),linear-gradient(135deg,#100b18,#020203)] sm:h-36">
            {member.banner && (
              <img src={member.banner} alt={`${member.name} banner`} className="absolute inset-0 h-full w-full object-cover" loading="lazy" />
            )}
            <div className="absolute inset-0 bg-gradient-to-t from-[#08060d] via-[#08060d]/20 to-black/20" />
            <div className="absolute inset-0 opacity-25 [background-image:linear-gradient(rgba(255,255,255,.06)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.06)_1px,transparent_1px)] [background-size:18px_18px]" />
          </div>
